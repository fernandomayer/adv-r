...
\CommentTok{#> [1] "0x27b6048" "0x27b6048"}

\NormalTok{x[}\DecValTok{5}\NormalTok{] <-}\StringTok{ }\NormalTok{6L}
\KeywordTok{c}\NormalTok{(}\KeywordTok{address}\NormalTok{(x), }\KeywordTok{address}\NormalTok{(y))}
\CommentTok{#> [1] "0x1160ef0" "0x27b6048"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\}}
\CommentTok{#> [1] "0x30c9bd0" "2"        }
\CommentTok{#> [1] "0x33989b0" "2"        }
\CommentTok{#> [1] "0x2f394d0" "2"        }
\CommentTok{#> [1] "0x1dee150" "2"        }
\CommentTok{#> [1] "0x30fd860" "2"}
\end{Highlighting}
\end{Shaded}
